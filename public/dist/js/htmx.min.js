...
// public/src/js/htmx.min.js
var htmx = function() {
  "use strict";
  const Q = { onLoad: null, process: null, on: null, off: null, trigger: null, ajax: null, find: null, findAll: null, closest: null, values: /* @__PURE__ */ __name(function(e2, t2) {
  ...
  Q.parseInterval = d;
  Q._ = e;
  const n = { addTriggerHandler: St, bodyContains: le, canAccessLocalStorage: B, findThisElement: Se, filterValues: hn, swap: $e, hasAttribute: s, getAttributeValue: te, getClosestAttributeValue: re, getClosestMatch: o, getExpressionVars: En, getHeaders: fn, getInputValues: cn, getInternalData: ie, getSwapSpecification: gn, getTriggerSpecs: st, getTarget: Ee, makeFragment: P, mergeObjects: ce, makeSettleInfo: xn, oobSwap: He, querySelectorExt: ae, settleImmediately: Kt, shouldCancel: ht, triggerEvent: he, triggerErrorEvent: fe, withExtensions: Ft };
  const r = ["get", "post", "put", "delete", "patch"];
  const H = r.map(function(e2) {
  ...
  __name(re, "re");
  function h(e2, t2) {
    const n2 = e2 instanceof Element && (e2.matches || e2.matchesSelector || e2.msMatchesSelector || e2.mozMatchesSelector || e2.webkitMatchesSelector || e2.oMatchesSelector);
  ...
  __name(A, "A");
  function N(e2) {
    return e2.matches("script") && (e2.type === "text/javascript" || e2.type === "module" || e2.type === "");
  }
  __name(N, "N");
  function I(e2) {
  ...
  __name(J, "J");
  function f(e2) {
    return e2 instanceof Element || e2 instanceof Document || e2 instanceof DocumentFragment ? e2 : null;
  }
  __name(f, "f");
  function K(e2, t2, n2) {
    e2 = ue(y(e2));
  ...
  __name(p, "p");
  var pe = /* @__PURE__ */ __name(function(t2, e2, n2) {
  ...
  var me = /* @__PURE__ */ __name(function(t2, e2, n2) {
    const r2 = f(m(t2, n2)).querySelectorAll(e2);
            ...
            if (l2) {
              if (Array.isArray(l2)) {
                for (let e4 = 0; e4 < l2.length; e4++) {
                  const c2 = l2[e4];
                  if (c2.nodeType !== Node.TEXT_NODE && c2.nodeType !== Node.COMMENT_NODE) {
                    o2.tasks.push(Ae(c2));
                  }
                }
              }
  ...
  function $e(e2, t2, r2, o2) {
    ...
    if (s2.elt && !le(s2.elt) && ee(s2.elt, "id")) {
      ...
      const p2 = { preventScroll: r2.focusScroll !== void 0 ? !r2.focusScroll : !Q.config.defaultFocusScroll };
      if (g2) {
  ...
  function tt(e2, t2, n2) {
    return Ge.exec(e2.charAt(0)) && e2 !== "true" && e2 !== "false" && e2 !== "this" && e2 !== n2 && t2 !== ".";
  }
  __name(tt, "tt");
          ...
          while (o2.length > 0 && o2[0] !== ",") {
            ...
            if (f2 === "changed") {
              ...
              if (Ye.test(o2[0])) {
                ...
                var s2 = C(o2, v);
                if (s2 === "closest" || s2 === "find" || s2 === "next" || s2 === "previous") {
                  o2.shift();
                  const h2 = rt(o2);
                  if (h2.length > 0) {
                    s2 += " " + h2;
  ...
  function ft(t2, n2, e2) {
    if (t2 instanceof HTMLAnchorElement && ut(t2) && (t2.target === "" || t2.target === "_self") || t2.tagName === "FORM" && String(ee(t2, "method")).toLowerCase() !== "dialog") {
      n2.boosted = true;
      let r2, o2;
      if (t2.tagName === "A") {
        r2 = "get";
  ...
  function ht(e2, t2) {
    ...
    if (e2.type === "submit" || e2.type === "click") {
      ...
      if (n2 instanceof HTMLAnchorElement && n2.href && (n2.getAttribute("href") === "#" || n2.getAttribute("href").indexOf("#") !== 0)) {
        return true;
      }
    }
    return false;
  ...
  __name(ht, "ht");
  function dt(e2, t2) {
    return ie(e2).boosted && e2 instanceof HTMLAnchorElement && t2.type === "click" && (t2.ctrlKey || t2.metaKey);
  }
  __name(dt, "dt");
  ...
  function pt(l2, c2, e2, u2, a2) {
    ...
    se(t2, function(i2) {
      const s2 = /* @__PURE__ */ __name(function(e3) {
        if (!le(l2)) {
  ...
  function yt() {
    if (!xt) {
      ...
      setInterval(function() {
        if (mt) {
          mt = false;
          se(ne().querySelectorAll("[hx-trigger*='revealed'],[data-hx-trigger*='revealed']"), function(e2) {
            bt(e2);
          });
        }
      }, 200);
  ...
  function bt(e2) {
    if (!s(e2, "data-hx-revealed") && X(e2)) {
      ...
      if (t2.initHash) {
        ...
        e2.addEventListener("htmx:afterProcessNode", function() {
          he(e2, "revealed");
        }, { once: true });
      }
    }
  ...
  function vt(e2, t2, n2, r2) {
    const o2 = /* @__PURE__ */ __name(function() {
      if (!n2.loaded) {
        n2.loaded = true;
        he(e2, "htmx:trigger");
        t2(e2);
  ...
  function Ht(e2) {
    if (e2.querySelectorAll) {
      ...
      const o2 = e2.querySelectorAll(H + n2 + ", form, [type='submit'], [hx-ext], [data-hx-ext], [hx-trigger], [data-hx-trigger]" + r2.flat().map((e3) => ", " + e3).join(""));
      return o2;
    } else {
      return [];
    }
  ...
  function Nt(t2, e2, n2) {
    ...
    let o2;
    const i2 = /* @__PURE__ */ __name(function(e3) {
      vn(t2, function() {
        if (at(t2)) {
          return;
        }
  ...
  function Gt(o2) {
    ...
    e2.onload = function() {
      if (this.status >= 200 && this.status < 400) {
        ...
        Kt(r2.tasks);
        Bt = o2;
        he(ne().body, "htmx:historyRestore", { path: o2, cacheMiss: true, serverResponse: this.response });
      } else {
  ...
  function tn(e2) {
    ...
    if (t2.type === "button" || t2.type === "submit" || t2.tagName === "image" || t2.tagName === "reset" || t2.tagName === "file") {
      return false;
    }
  ...
  function cn(e2, t2) {
    ...
    let l2 = e2 instanceof HTMLFormElement && e2.noValidate !== true || te(e2, "hx-validate") === "true";
    ...
    on(n2, r2, i2, e2, l2);
    if (s2.lastButtonClicked || e2.tagName === "BUTTON" || e2.tagName === "INPUT" && ee(e2, "type") === "submit") {
  ...
  function fn(e2, t2, n2) {
    const r2 = { "HX-Request": "true", "HX-Trigger": ee(e2, "id"), "HX-Trigger-Name": ee(e2, "name"), "HX-Target": te(t2, "id"), "HX-Current-URL": ne().location.href };
  ...
  function gn(e2, t2) {
    ...
    const r2 = { swapStyle: ie(e2).boosted ? "innerHTML" : Q.config.defaultSwapStyle, swapDelay: Q.config.defaultSwapDelay, settleDelay: Q.config.defaultSettleDelay };
  ...
  __name(gn, "gn");
  function pn(e2) {
    return re(e2, "hx-encoding") === "multipart/form-data" || h(e2, "form") && ee(e2, "enctype") === "multipart/form-data";
  }
  __name(pn, "pn");
  ...
  function Rn(t2, n2, r2) {
    ...
    if (r2) {
      if (r2 instanceof Element || typeof r2 === "string") {
        ...
        return de(t2, n2, y(r2.source), r2.event, { handler: r2.handler, headers: r2.headers, values: r2.values, targetOverride: e2, swapOverride: r2.swap, select: r2.select, returnPromise: true });
      }
    } else {
  ...
  function Ln(r2, o2, e2) {
    return new Proxy(e2, { get: /* @__PURE__ */ __name(function(t2, e3) {
    ...
    }, "get"), set: /* @__PURE__ */ __name(function(e3, t2, n2) {
      e3[t2] = n2;
      r2.delete(o2);
  ...
  __name(Ln, "Ln");
  function An(o2) {
    return new Proxy(o2, { get: /* @__PURE__ */ __name(function(e2, t2) {
      if (typeof t2 === "symbol") {
    ...
    }, "get"), set: /* @__PURE__ */ __name(function(t2, n2, e2) {
      if (typeof n2 !== "string") {
        return false;
      }
      t2.delete(n2);
      ...
      return true;
    }, "set"), deleteProperty: /* @__PURE__ */ __name(function(e2, t2) {
      if (typeof t2 === "string") {
        e2.delete(t2);
      }
      return true;
    }, "deleteProperty"), ownKeys: /* @__PURE__ */ __name(function(e2) {
      return Reflect.ownKeys(Object.fromEntries(e2));
    }, "ownKeys"), getOwnPropertyDescriptor: /* @__PURE__ */ __name(function(e2, t2) {
  ...
  function de(t2, n2, r2, o2, i2, D2) {
    ...
    if (D2 === void 0) {
      const K2 = /* @__PURE__ */ __name(function(e3) {
        return de(t2, n2, r2, o2, i2, !!e3);
      }, "K");
      const G2 = { target: c2, elt: r2, path: n2, verb: t2, triggeringEvent: o2, etc: i2, issueRequest: K2, question: f2 };
    ...
    u2.xhr = p2;
    u2.abortable = F2;
    const m2 = /* @__PURE__ */ __name(function() {
      u2.xhr = null;
      u2.abortable = false;
    ...
    const C2 = { boosted: _2, useUrlParams: E2, formData: w2, parameters: An(w2), unfilteredFormData: v2, unfilteredParameters: An(v2), headers: y2, target: c2, verb: t2, errors: b2, withCredentials: i2.credentials || S2.credentials || Q.config.withCredentials, timeout: i2.timeout || S2.timeout || Q.config.timeout, path: n2, triggeringEvent: o2 };
    ...
    const H2 = { xhr: p2, target: c2, requestConfig: C2, etc: i2, boosted: _2, select: X2, pathInfo: { requestPath: n2, finalRequestPath: R2, responsePath: null, anchor: O2 } };
    p2.onload = function() {
      try {
        const t3 = Hn(r2);
    ...
    se(["loadstart", "loadend", "progress", "abort"], function(t3) {
      se([p2, p2.upload], function(e3) {
        e3.addEventListener(t3, function(e4) {
          he(r2, "htmx:xhr:" + t3, { lengthComputable: e4.lengthComputable, loaded: e4.loaded, total: e4.total });
        });
      });
    });
  ...
  function Dn(o2, i2) {
    ...
    var p2 = s2.response;
    var m2 = ce({ shouldSwap: a2, serverResponse: p2, isError: f2, ignoreTitle: h2, selectOverride: d2, swapOverride: g2 }, i2);
    ...
    if (m2.shouldSwap) {
      ...
      let e3 = /* @__PURE__ */ __name(function() {
        try {
          if (u2.type) {
          ...
          $e(l2, p2, x2, { select: d2 || b2, selectOOB: y2, eventInfo: i2, anchor: i2.pathInfo.anchor, contextElement: o2, afterSwapCallback: /* @__PURE__ */ __name(function() {
          ...
          }, "afterSwapCallback"), afterSettleCallback: /* @__PURE__ */ __name(function() {
      ...
      if (t3 && he(o2, "htmx:beforeTransition", i2) && typeof Promise !== "undefined" && document.startViewTransition) {
    ...
    if (f2) {
      fe(o2, "htmx:responseError", ce({ error: "Response Status Error Code " + s2.status + " from " + i2.pathInfo.requestPath }, i2));
    }
  }
  __name(Dn, "Dn");
  const Mn = {};
  function Xn() {
    return { init: /* @__PURE__ */ __name(function(e2) {
      return null;
    }, "init"), getSelectors: /* @__PURE__ */ __name(function() {
      return null;
    }, "getSelectors"), onEvent: /* @__PURE__ */ __name(function(e2, t2) {
      return true;
    }, "onEvent"), transformResponse: /* @__PURE__ */ __name(function(e2, t2, n2) {
      return e2;
    }, "transformResponse"), isInlineSwap: /* @__PURE__ */ __name(function(e2) {
      return false;
    }, "isInlineSwap"), handleSwap: /* @__PURE__ */ __name(function(e2, t2, n2, r2) {
      return false;
    }, "handleSwap"), encodeParameters: /* @__PURE__ */ __name(function(e2, t2, n2) {
      return null;
    }, "encodeParameters") };
  }
  __name(Xn, "Xn");
  ...
  function _n() {
    if (Q.config.includeIndicatorStyles !== false) {
      ...
      ne().head.insertAdjacentHTML("beforeend", "<style" + e2 + ">      ." + Q.config.indicatorClass + "{opacity:0}      ." + Q.config.requestClass + " ." + Q.config.indicatorClass + "{opacity:1; transition: opacity 200ms ease-in;}      ." + Q.config.requestClass + "." + Q.config.indicatorClass + "{opacity:1; transition: opacity 200ms ease-in;}      </style>");
    }
  }
  __name(_n, "_n");
  function zn() {
